        ...
        <div className="hidden lg:flex flex-col justify-center">
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground">
              Zeichne deine Träume auf, analysiere deren Bedeutung und entdecke
              wiederkehrende Muster und Symbole. Mit KI-gestützter Analyse
              erhältst du Einblicke in deine Traumwelt.
            </p>
            <ul className="space-y-2 text-muted-foreground">
              <li className="flex items-center gap-2">
                <span className="text-primary">✓</span> Aufzeichnung deiner
                Träume mit Text und Bildern
              </li>
              <li className="flex items-center gap-2">
                <span className="text-primary">✓</span> KI-gestützte Analyse der
                Traumsymbole und -themen
              </li>
              <li className="flex items-center gap-2">
                <span className="text-primary">✓</span> Erkennung von Mustern in
                deinen Träumen
              </li>
              <li className="flex items-center gap-2">
                <span className="text-primary">✓</span> Sicherer, privater
                Traumspeicher
              </li>
            </ul>
          </div>
