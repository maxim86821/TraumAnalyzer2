...
export default function Home() {
  ...
  const filteredDreams = dreams?.filter((dream) => {
    ...
    return (
      ...
      (dream.analysis &&
        JSON.parse(dream.analysis).themes?.some((theme: string) =>
  ...
  return (
    <div>
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-8">
        <div>
          <h1 className="text-2xl lg:text-3xl font-serif font-bold text-gray-800">
            Meine Traumsammlung
          </h1>
          <p className="text-gray-600 mt-1">
            Entdecke und analysiere deine nächtlichen Abenteuer
          </p>
        </div>
            ...
            {filteredDreams && filteredDreams.length > 0 ? (
              ...
              <div className="bg-white rounded-xl shadow-md p-8 text-center">
                ...
                <p className="text-gray-500 mb-4">
                  Es wurden keine Träume gefunden, die "{searchQuery}"
                  enthalten.
                </p>
                <Button
          ...
          <div className="bg-white rounded-xl shadow-md p-8 text-center">
            <div className="mx-auto w-16 h-16 bg-dream-light rounded-full flex items-center justify-center mb-4">
              <svg
                ...
                className="h-8 w-8 text-dream-primary"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">
              Keine Träume gefunden
            </h3>
            <p className="text-gray-500 mb-4">
              Du hast noch keine Träume in deinem Tagebuch. Beginne damit,
              deinen ersten Traum zu erfassen.
            </p>
