...
export default function DreamDetail({ dream }: DreamDetailProps) {
  ...
  const generateDreamImage = async () => {
    ...
    try {
      ...
      setNewImage(data.dream.imageUrl);
  ...
  return (
    <>
      <section className="bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden">
          ...
          <div className="lg:w-2/3 p-6">
            {editing ? (
              <div className="space-y-4">
                ...
                {/* Mood */}
                <div>
                  <h4 className="text-sm font-medium text-gray-700 mb-2">Stimmung</h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {/* Before sleep mood */}
                    <div>
                      <label htmlFor="moodBeforeSleep" className="block text-sm text-gray-600 mb-1">
                      ...
                      <Input 
                        ...
                        onChange={(e) => setMoodBeforeSleep(e.target.value ? parseInt(e.target.value, 10) : null)} 
                      />
                    </div>
                    
                    {/* After wakeup mood */}
                    <div>
                      <label htmlFor="moodAfterWakeup" className="block text-sm text-gray-600 mb-1">
                      ...
                      <Input 
                        ...
                        onChange={(e) => setMoodAfterWakeup(e.target.value ? parseInt(e.target.value, 10) : null)} 
                      />
                    </div>
                  </div>
                  ...
                  {/* Mood notes */}
                  <div className="mt-3">
                    <label htmlFor="moodNotes" className="block text-sm text-gray-600 mb-1">
                    ...
                    <Textarea 
                      ...
                      className="w-full"
                      placeholder="Zusätzliche Informationen zur Stimmung..."
                    />
                  </div>
                </div>
                  ...
                  {imagePreview ? (
                    <div className="relative">
                      <img 
                        src={imagePreview} 
                        alt="Preview" 
                        className="max-h-60 rounded-md object-contain shadow-md" 
                      />
                      <Button 
                        variant="destructive" 
                        size="sm" 
              ...
              <div className="space-y-6">
                ...
                {dream.moodNotes && (
                  <div className="mt-4 bg-gray-50 p-4 rounded-md shadow-sm">
                    <h4 className="text-sm font-medium text-gray-700 mb-2">Stimmungs-Notizen</h4>
              ...
              'directText' in analysis ? (
                ...
                <>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {analysis.themes && analysis.themes.map((theme: string, index: number) => {
                        ...
                        return (
                          <span 
                            key={index} 
                            className={`inline-block ${colorClass} text-sm px-3 py-1 rounded-full font-medium hover:scale-105 transition-all shadow-sm`}
                          >
                            {theme}
                          </span>
                        );
                    ...
                    <div className="flex flex-col space-y-2">
                      {analysis.emotions && analysis.emotions.map((emotion: { name: string, intensity: number }, index: number) => (
                        <div key={index} className="flex items-center">
                          ...
                          <div className="flex-grow bg-gray-200 rounded-full h-2 shadow-inner">
                            <div 
                  ...
                  <div className="mb-6">
                    ...
                    <ul className="text-sm text-gray-700 space-y-2">
                      {analysis.symbols && analysis.symbols.map((symbol: { symbol: string, meaning: string }, index: number) => (
                        <li key={index} className="flex flex-col bg-white p-2 rounded-md shadow-sm">
                    ...
                    <div className="mb-6">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {analysis.keywords.map((keyword: string, index: number) => (
                          <span 
                            key={index} 
                            className="inline-block bg-dream-dark/10 text-dream-dark text-sm px-3 py-1 rounded-full font-medium shadow-sm hover:bg-dream-dark/15 transition-colors"
                          >
                            {keyword}
                          </span>
                        ))}
                    ...
                    <div className="mb-6">
                      ...
                      <div className="space-y-4">
                        {analysis.keywordReferences.map((ref: any, index: number) => (
                          <div key={index} className="border-l-2 border-dream-primary pl-3 bg-white p-2 rounded-r-md shadow-sm">
                  ...
                  {analysis.quote && typeof analysis.quote === 'object' && analysis.quote.text && (
                    <div className="mb-6">
                      <blockquote className="text-sm italic text-gray-600 border-l-4 border-dream-accent pl-3 py-2 bg-white shadow-sm rounded-r-md">
                        "{analysis.quote.text}"
                  ...
                  {analysis.motivationalInsight && (
                    <div className="mb-6">
                      ...
                      <p className="text-sm italic text-gray-600 bg-white p-3 rounded-md shadow-sm">{analysis.motivationalInsight}</p>
                    </div>
                  )}
                  
                  {/* Weekly Insight if available */}
                  {analysis.weeklyInsight && typeof analysis.weeklyInsight === 'object' && (
                    <div className="bg-dream-light/50 p-4 rounded-lg border border-dream-primary/20 mt-4 shadow-sm">
