            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  {moodBeforeSleep && (
                    <div
                      className={`w-5 h-5 rounded-full bg-${moodBeforeSleep >= 7 ? "green" : moodBeforeSleep >= 4 ? "yellow" : "red"}-${moodBeforeSleep >= 8 ? "500" : moodBeforeSleep >= 6 ? "400" : moodBeforeSleep >= 4 ? "300" : "500"}`}
                    ></div>
                  )}
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  {moodAfterWakeup && (
                    <div
                      className={`w-5 h-5 rounded-full bg-${moodAfterWakeup >= 7 ? "green" : moodAfterWakeup >= 4 ? "yellow" : "red"}-${moodAfterWakeup >= 8 ? "500" : moodAfterWakeup >= 6 ? "400" : moodAfterWakeup >= 4 ? "300" : "500"}`}
                    ></div>
                  )}
                </div>
              </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                {analysis.themes && analysis.themes.length > 0 && (
                  <div>
                    <h4 className="text-xs uppercase text-gray-500 font-medium mb-1">
                      Themen
                    </h4>
                    <div className="flex flex-wrap gap-1.5">
                      {analysis.themes.map((theme: string, index: number) => (
                        <Badge
                          key={index}
                          className="bg-dream-primary/10 text-dream-primary hover:bg-dream-primary/15 border-dream-primary/20"
                        >
                          {theme}
                        </Badge>
                      ))}
                    ...
                    <div className="flex flex-wrap gap-1.5">
                      {dream.tags.map((tag, index) => (
                        <Badge
                          key={index}
                          variant="outline"
                          className="bg-dream-secondary/10 text-dream-secondary hover:bg-dream-secondary/15 border-dream-secondary/20"
                        >
                          {tag}
                        </Badge>
                      ))}
                      ...
                      {analysis.emotions.map(
                        (
                          ...
                          <div key={index} className="flex items-center">
                            <span className="text-sm w-24 text-gray-700">
                              {emotion.name}
                            </span>
                      ...
                      {analysis.symbols.map(
                        (
                          ...
                          <div key={index} className="text-sm">
                            <span className="font-medium text-dream-primary">
                              {symbol.symbol}
                            </span>
